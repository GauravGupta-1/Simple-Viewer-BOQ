(function (e) {
    ...
    function A(t, n, i) {
        typeof i == "string" && (i = {
            ...
            this.options = E(w, e.isPlainObject(i) ? i : {}),
            this.loadHTML(),
    ...
    A.prototype.loadHTML = function () {
        ...
        A.prototype.setElementPosition = function () {
            ...
            H = this.getPosition(),
                ...
                p[A] = _ === "b" ? d : _ === "r" ? y : 0,
                C(p, "top", g.top - j.top),
                C(p, "left", g.left - j.left),
                B = ["top", "left"];
            for (w = 0,
                S = B.length; w < S; w++)
                D = B[w],
                    N = parseInt(this.elem.css("margin-" + D), 10),
                    N && C(p, D, N);
            ...
            if (!this.options.arrowShow)
                ...
                C(p, s[L], i),
                    t.call(a, O) >= 0 && C(r, s[O], i * 2)
            }
            t.call(u, _) >= 0 ? (C(p, "left", k(O, h, y)),
                r && C(r, "left", k(O, i, m))) : t.call(o, _) >= 0 && (C(p, "top", k(O, c, d)),
                    r && C(r, "top", k(O, i, v))),
        ...
        A.prototype.run = function (t, n) {
            ...
            for (o in s) {
                ...
                u === "text" && (r = L(r),
                    ...
                    a = o === i ? "" : "=" + o,
                    b(this.userContainer, "[data-notify-" + u + a + "]").html(r)
            }
            this.updateClasses(),
