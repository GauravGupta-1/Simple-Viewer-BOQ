...
//    const buff = fs.readFileSync(path.join(__dirname, '..', 'samples', 'Project1.rvt'));
//    const obj = await data.uploadObject(config.bucket, 'Project1.rvt', 'application/octet-stream', buff);
